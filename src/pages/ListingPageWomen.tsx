...
export default function ListingPageWomen() {
      ...
      <div className='grid grid-cols-4 gap-4'>
        <div className="col-span-1 rounded-md border border-grey">
          ...
          <div className='filter-box'>
            ...
            <Checkbox label="Kurti" value="Kurti" checkBoxHandler={onCheckChangeHandler} />
            <Checkbox label="Saree" value="saree" checkBoxHandler={onCheckChangeHandler} />
        ...
        <div className='col-span-3'>
          <div className='flex items-center justify-between w-full'>
            <div>
              <h5 className='text-2xl font-extrabold'>Women</h5>
              <ul className='flex items-center w-full'>
                ...
                <li>
                  <a href='#' className='breadcrumb-link active-breadcrumb ms-2 text-xs'> / Women <span className='total-num text-primary'>(12024 items)</span></a>
                </li>
              </ul>
            </div>
